...
<main id = "main" class ="container-fluid">	
      ...
      <form method="POST" action="szukaj_nazwisko.php">
      <p>Szukaj Artykułów autora:</p>
<a>Podaj Imie Autora    </a><input type="text" size="40" name="zapytanie"><br><br>
<a>Podaj Nazwisko Autora    </a><input type="text" size="40" name="nazwisko"><br><br>
<input type="submit" value="Wyswietl Artykul" class="btn btn-dark"><a href=szukaj_nazwisko.php><br>
</form>
